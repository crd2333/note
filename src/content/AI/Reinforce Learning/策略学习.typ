...
- 回顾
  #fig("/public/assets/AI/RL/img-2024-07-05-09-36-52.png", width: 50%)
  #fig("/public/assets/AI/RL/img-2024-07-05-09-38-37.png", width: 50%)
- 策略参数化（例如 DQN）
...
- 目标函数
  #fig("/public/assets/AI/RL/img-2024-07-05-09-59-33.png", width: 50%)
- 状态分布$d(s)$
  - 策略无关的状态分布
...
- 如果采用最大化平均轨迹回报目标函数$ max_theta J(theta)=max_theta EE_(tau wave p_theta (tau)) [sum_t r(s_t,a_t)] $
  ...
  #fig("/public/assets/AI/RL/img-2024-07-05-10-18-35.png", width: 50%)
- 另外两种目标函数和策略梯度
  #fig("/public/assets/AI/RL/img-2024-07-05-10-19-19.png", width: 50%)
...
#fig("/public/assets/AI/RL/img-2024-07-05-15-16-33.png", width: 60%)
- 思考强化学习与分类问题对比
  + 都是输入状态，输出要采取的行为
  + 分类问题（监督学习）：假设有带标签的训练数据，随后利用极大似然法进行优化
  + 强化学习：没有标签，只能通过试错的方式与环境交互获取奖励，以替代监督信息进行训练
- 一个问题——*训练可能存在偏差*
  #fig("/public/assets/AI/RL/img-2024-07-05-10-41-17.png", width: 60%)
...
#fig("/public/assets/AI/RL/img-2024-07-05-15-17-48.png", width: 70%)
- Advantage Actor-Critc (A2C) 算法
  ...
  - 状态值估计$hat(V)^pi$能否与策略 $pi_theta$ 共用网络？
    #fig("/public/assets/AI/RL/img-2024-07-05-11-15-17.png", width: 70%)
  ...
  - 批量更新（没听懂）
    ...
    - 解决方案：获得一个批次的数据后再进行更新，分为同步和异步两种方法
      #fig("/public/assets/AI/RL/img-2024-07-05-11-22-12.png", width: 70%)
    - 批量更新再改进
      #fig("/public/assets/AI/RL/img-2024-07-05-11-22-32.png", width: 70%)
