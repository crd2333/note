...
#note(caption: "时序差分 v.s. 蒙特卡洛")[
  ...
  #grid(
    ...
    grid.cell(align:horizon, rowspan: 3)[
      #fig("/public/assets/AI/RL/2025-01-04-14-07-08.png")
      #fig("/public/assets/AI/RL/2025-01-04-14-15-54.png")
    ],
...
- TD-$lambda$ 的两种视角
#grid2(
  fig("/public/assets/AI/RL/img-2024-07-10-14-21-56.png", width: 80%),
  fig("/public/assets/AI/RL/img-2024-07-10-14-22-17.png", width: 80%)
)
...
- SARSA 中新的 $Q(s,a)$ 通过当前策略得到，而 Q-Learning 通过 $max_a Q(s,a)$ 选取（行为策略），除此之外代码上非常类似
  #fig("/public/assets/AI/RL/2025-01-04-15-05-19.png",width: 30%)
- 为什么使用离线策略学习
...
- 训练时，有两种方法：*fitted Q 值迭代*和*在线 Q 值迭代算法*
  #fig("/public/assets/AI/RL/2025-01-04-16-03-39.png", width:40%)
  - 两种方法都有一些问题
  ...
  - 第二第三个通过*目标网络*解决
- 最后得到经典 DQN 网络
#fig("/public/assets/AI/RL/img-2024-07-04-16-11-51.png", width:50%)
...
- 引出 Double DQN，使用两个网络减少随机噪声的影响
  ...
  #fig("/public/assets/AI/RL/img-2024-07-04-16-20-27.png", width: 50%)
- 其算法流程
...
=== Dueling DQN
  ...
  #grid2(
    fig("/public/assets/AI/RL/img-2024-07-04-16-31-52.png", width: 80%),
    fig("/public/assets/AI/RL/img-2024-07-04-16-34-33.png", width: 60%)
  )
  - 为什么要这样拆呢？分辨当前的价值是由状态价值提供还是行为价值提供，进而有针对性的更新，增加样本利用率。如上右图中，当前方有车时，不同$a$应有不同的优势价值$A_theta (s,a)$；而$V(s)$则更关注远方的目标
  #fig("/public/assets/AI/RL/img-2024-07-04-16-47-05.png", width: 50%)
