...
- MARL(Multi-Agents RL) 挑战
  ...
  - 探索：指数级别的联合策略空间
- MARL 范例
  #fig("/public/assets/AI/RL/img-2024-07-09-10-17-41.png",width:60%)
  - 可扩展的集中训练与分布式执行过程
...
- 值分解算法（线性）
  - 方法一(VDN)
  #fig("/public/assets/AI/RL/img-2024-07-09-10-28-30.png",width:60%)
  - 方法二(DOP)
  #fig("/public/assets/AI/RL/img-2024-07-09-10-29-09.png",width:60%)
- 线性值分解局限性
  - 有限的表征能力
  - 没有全局收敛保证
...
- QMIX
  ...
  #fig("/public/assets/AI/RL/img-2024-07-09-10-44-22.png",width:60%)
- QPLEX
  - 相当于 MA 版本的 DQN $->$ Dueling DQN，把 $Q$ 值改为 Advantage
  #fig("/public/assets/AI/RL/img-2024-07-09-10-49-41.png",width:60%)
...
== MADDPG
- 首先回顾 DDPG
  #fig("/public/assets/AI/RL/img-2024-07-11-09-45-21.png",width:70%)
- 传统算法在多智能体环境中有以下几个困境
...
- 算法流程如下：
  #fig("/public/assets/AI/RL/img-2024-07-12-11-31-06.png",width:60%)
...
#fig("/public/assets/AI/RL/img-2024-07-11-10-11-13.png",width:60%)
