...
- 之前讲的 MA 都是基于 CTDE 的假设，即智能体在学习的过程中可以获取全局信息，但是在执行的过程中是分布式的。但是在一些情况下，智能体在学习和执行的过程中都是分布式的，这就是完全去中心化学习
  #fig("/public/assets/AI/RL/img-2024-07-12-09-45-22.png", width: 80%)
...
- 思路：智能体不同步更新，每次只有一个智能体进行策略更新
  - IQL 没有收敛保证，MA2QL 有
  #fig("/public/assets/AI/RL/img-2024-07-12-09-59-53.png", width: 80%)
- MA2QL：多智能体轮流策略迭代
  - 有收敛保证（纳什均衡），即收敛但未必全局最优
  - 这种轮流迭代的方法无论是基于策略还是基于价值函数，最终都会收敛到纳什均衡
  #fig("/public/assets/AI/RL/img-2024-07-12-10-09-46.png", width: 80%)
  - 轮流更新与单步策略提升需要太久收敛
...
#grid(
  ...
  - 一般分为以下几个模块（右图）：
    ...
    - 通信模块
    - 数据与模型聚合模块
  #fig("/public/assets/AI/RL/img-2024-07-12-10-25-09.png", width: 80%)
  #fig("/public/assets/AI/RL/img-2024-07-12-10-26-01.png", width: 80%)
  ],
  [
  #fig("/public/assets/AI/RL/img-2024-07-12-10-22-08.png", width: 80%)
  - 模型聚合的基本方式（左图）：
...
- 并行PPO(DPPO)
  ...
  #fig("/public/assets/AI/RL/img-2024-07-12-10-46-48.png", width: 80%)
  - 哪些流程可以并行：
  ...
  #fig("/public/assets/AI/RL/img-2024-07-12-10-48-58.png", width: 80%)
- DPPO 存在的问题：
...
- 通过逆强化学习
  ...
  - 西瓜书中
    ...
    #fig("/public/assets/AI/RL/2025-01-04-19-51-00.png", width: 50%)
