...
#fig("/public/assets/AI/DL/basic/img-2024-07-03-16-29-29.png", width: 80%)
- RNN 最大的问题是梯度消失和梯度爆炸
- RNN 本身的改进有：多层 RNN 和双向 RNN
  ...
  #grid(
    columns:2,
    fig("/public/assets/AI/DL/basic/img-2024-07-03-16-33-24.png", width: 80%),
    grid.cell(align: horizon, fig("/public/assets/AI/DL/basic/img-2024-07-03-16-32-55.png"))
  )
...
#fig("/public/assets/AI/DL/basic/img-2024-07-03-22-06-17.png", width: 90%)
...
- 参数更少，性能不减
#fig("/public/assets/AI/DL/basic/img-2024-07-03-22-09-41.png", width: 90%)
...
#fig("/public/assets/AI/DL/basic/img-2024-07-03-22-14-26.png", width: 90%)
...
- 将神经网路用在图上面最核心的问题是：如何表示图使得它能够和神经网络兼容
  ...
  #fig("/public/assets/AI/DL/basic/2024-09-24-16-16-29.png", width: 90%)
...
- 一个最简单利用了 MLP 的网络层，对顶点向量、边向量和全局向量分别做 MLP
  #fig("/public/assets/AI/DL/basic/2024-09-24-11-04-44.png", width: 90%)
- 最后再加一个分类层，就可以对顶点或边或全局做分类，或者加上*汇聚*操作也可以进行预测
  #fig("/public/assets/AI/DL/basic/2024-09-24-11-07-03.png", width: 90%)
- 一个问题在于：对每个属性做变换的时候，仅仅是每个属性进入自己对应的 MLP，并没有体现出三者之间的相互联系的连接信息
  ...
  #grid2(
    fig("/public/assets/AI/DL/basic/2024-09-24-11-16-32.png", width: 90%),
    fig("/public/assets/AI/DL/basic/2024-09-24-11-16-40.png", width: 90%)
  )
  - 和卷积操作有点类似，但是还是有区别（汇聚时权重相等），之所以不做权重是因为图的连接比卷积的位置权重灵活得多
- 加入全局信息 master node，跟所有 node 和 edge 都相连
  #fig("/public/assets/AI/DL/basic/2024-09-24-12-04-15.png", width: 90%)
