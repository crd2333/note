...
#fig("/public/assets/AI/DL/LLM/2024-09-21-17-14-54.png")
- 它包含两个预训练任务：
...
- BERT 微调
  ...
  #grid2(
    fig("/public/assets/AI/DL/LLM/2024-09-22-15-53-32.png"),
    fig("/public/assets/AI/DL/LLM/2024-09-22-15-53-48.png")
  )
  - 词元级应用：文本标注（如词性分类）、问答（如把语料和问题作为句子对，对语料的每个 token 判断是否是回答的开始与结束）
  #grid2(
    fig("/public/assets/AI/DL/LLM/2024-09-22-15-55-57.png"),
    fig("/public/assets/AI/DL/LLM/2024-09-22-15-56-28.png")
  )
