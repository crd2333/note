...
#fig("/public/assets/CV/Representations/2024-10-10-16-02-46.png", width: 60%)
- *体素*
...
#grid(
  columns: (61%, 39%),
  fig("/public/assets/CV/Representations/2024-10-26-11-19-54.png"),
  fig("/public/assets/CV/Representations/2024-10-26-11-29-04.png")
)
- 然后用一张 NeRF 阵营图做结，不得不说总结得确实很有意思也挺有道理
  #fig("/public/assets/CV/Representations/2024-10-24-15-21-18.png")
