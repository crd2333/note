...
- 要想了解 Unity 着色器编程，需要对其整个的渲染管线有一定了解，参考
  ...
  + #link("https://zhuanlan.zhihu.com/p/378781638")[【Unity】SRP底层渲染流程及原理]
...
- 其它
  + #link("https://blog.csdn.net/qq_46044366/article/details/122806863")[Unity 事件番外篇：UnityEvent]
  + #link("https://blog.csdn.net/qq_46044366/article/details/122768530")[Unity 单例基类（运用单例模式）]
  + #link("https://blog.csdn.net/qq_46044366/article/details/122722948")[Unity 事件管理中心]
